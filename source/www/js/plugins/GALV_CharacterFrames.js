...
//-----------------------------------------------------------------------------
//  2025-06-17 - Version 1.4 - added ability to change file symbol.
...
//-----------------------------------------------------------------------------
/*:
 * @plugindesc v.1.4 Enables map character sheets to have more frames per character.
 * 
...
Galv.CF.regex = RegExp('\\' + PluginManager.parameters('Galv_CharacterFrames')["fileSymbol"] + '\\((.*)\\)','i');
...
Window_Base.prototype.drawCharacter = function(characterName, characterIndex, x, y) {
	var setFrame = characterName.match(Galv.CF.regex);
...
Sprite_Character.prototype.setCharacterBitmap = function() {
	var setFrame = this._characterName.match(Galv.CF.regex);
	if (setFrame) {
		this._cframes = Number(setFrame[1]);
